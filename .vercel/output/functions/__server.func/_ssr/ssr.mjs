...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_-2XvGO.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CRmJss36.mjs"),
		import("./start-CmFEMW55.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createStart as t };
